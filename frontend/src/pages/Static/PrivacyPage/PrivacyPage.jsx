            ...
            <div className={styles.content}>
                ...
                <section>
                    ...
                    <ul>
                        ...
                        <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Privacy Policy) refers to The House™ of Dice.</li>
                        ...
                        <li><strong>Website</strong> refers to The House™ of Dice, accessible from <a href="https://thehouseofdice.com" target="_blank" rel="noopener noreferrer">thehouseofdice.com</a>.</li>
                ...
                <section>
                    ...
                    <ul>
                        <li>By email: contact@houseofdice.com</li>
                    </ul>
                </section>
            </div>
        </div>
